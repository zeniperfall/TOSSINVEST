...
마지막 업데이트: 2026-04-28 (R5) · 작업 단위 표기 — **S**(시간) · **M**(일) · **L**(주)

현재 상태: 6개 페이지 정적 사이트, PWA · 다국어(KO/EN/JA) · 모바일 제스처 ·
백테스트 · **Stooq 실데이터 어댑터(opt-in)** 지원, **105/105** 검증 통과
(81 E2E + 24 unit), GitHub Pages 배포 완료
...
| 상태 | #   | 항목                                                                      | 단위 |
| ---- | --- | ------------------------------------------------------------------------- | ---- |
| 🟡   | 12  | 실데이터 — **Stooq 어댑터 opt-in 도입 완료**, Yahoo/AlphaVantage는 미진행 | L    |
...
- 완료: **24/38** (63%) + #12 부분 완료
- P0: 3/5 · P1: 6/6 · P2: 7/9 (#12 부분) · P3: 6/6 · P4: 3/7 · P5: 0/5
